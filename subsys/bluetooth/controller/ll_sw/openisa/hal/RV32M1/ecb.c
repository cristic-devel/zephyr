		    ...
		    u8_t * const cipher_text_be)
{
	 ...
	 * execute WFE opcode until CAU3 signals task done by setting
	 * the event.
	 */
		 ...
		 u8_t * const cipher_text_le, u8_t * const cipher_text_be)
{
	...
	/* After encryption/decryption req is sent to CAU3, the Host CPU will
	 * execute WFE opcode until CAU3 signals task done by setting
	 * the event.
	 */
	handle.taskDone = kCAU3_TaskDonePoll;
...
u32_t ecb_ut(void)
{
	static const u8_t keyAes128[] __aligned(4) = {
		0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6,
		0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c};
	static const u8_t plainAes128[] = {
		0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96,
		0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a};
	static const u8_t cipherAes128[] = {
